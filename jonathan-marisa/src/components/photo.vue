  ...
  <div class="photo">
      <v-container :fluid="fluid" :grid-list-md="!fluid" :pa-0="fluid">
        <v-layout justify-center row wrap>
          <v-flex :class="classObj" v-for="(photo, index) in photos" :key="index" @click="fluid ? '' : $emit('gallery', index)">

            <v-card flat tile v-if="fluid">
              <v-flex xs12 d-block>
                <img :src="photo.thumbnail.replace(/v[0-9]*/,'f_auto/h_720,c_scale/dpr_2.0')">
